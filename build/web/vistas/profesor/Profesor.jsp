            ...
            <div class="row p-2">
                <div class="col">
                    <div class="card-body border border-light rounded p-2">
                        <h5 class="card-title text-light text-uppercase p-3 fs-6">total de alumnos</h5>
                        <div class="body-card">
                            <div class="icon-card">
                ...
                <div class="col">
                    <div class="card-body border border-light rounded p-2">
                        <h5 class="card-title text-light text-uppercase p-3 fs-6">total de grupos</h5>
                        <div class="body-card">
                            <div class="icon-card">
                                <i class="bi bi-bank2 icon fs-5"></i>
                            </div>
                            <div class="text-card">
                                <h3 class="text-light fs-5">1,500</h3>
                            </div>
                ...
                <div class="col">
                    <div class="card-body border border-light rounded p-2">
                        <h5 class="card-title text-light text-uppercase p-3 fs-6">total de asignaturas</h5>
                        <div class="body-card">
                            <div class="icon-card">
                                <i class="bi bi-journal-bookmark-fill icon fs-5"></i>
                            </div>
                            <div class="text-card">
                                <h3 class="text-light fs-5">1,500</h3>
                            </div>
