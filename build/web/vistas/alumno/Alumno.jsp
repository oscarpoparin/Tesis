        ...
        <div class="container p-4 border-opacity-10 mt-5">
            <div class="row">
                <div class="col-8">
                    <div class="row p-2">
                        <div class="col p-2">
                            <a href="ruta-del-archivo-a-descargar" class="btn btn-secondary">
                    ...
                    <div class="row p-2">
                        <div class="col p-2">
                            <div class="card-body border border-light rounded p-4">
                                <div class="row">
                                    <h6 class="card-title text-light text-uppercase p-3 fs-6">documentos</h6>
                                </div>
                                <div class="row">
                                    <div class="col p-2">
                                        <h6 class="card-title text-light text-uppercase fs-6">acta de nacimiento</h6>
                                    </div>
                                    <div class="col p-2">
                                        <div class="float-end">
                                ...
                                <div class="row">
                                    <div class="col p-2">
                                        <h6 class="card-title text-light text-uppercase fs-6">curp</h6>
                                    </div>
                                    <div class="col p-2">
                                        <div class="float-end">
                                            <span class="container border border-success rounded-circle bg-success"></span>
                                ...
                                <div class="row">
                                    <div class="col p-2">
                                        <h6 class="card-title text-light text-uppercase fs-6">ine tutor</h6>
                                    </div>
                                    <div class="col p-2">
                                        <div class="float-end">
                                            <span class="container border border-success rounded-circle bg-success"></span>
                                ...
                                <div class="row">
                                    <div class="col p-2">
                                        <h6 class="card-title text-light text-uppercase fs-6">certificado de estudios</h6>
                                    </div>
                                    <div class="col p-2">
                                        <div class="float-end">
                                            <span class="container border border-success rounded-circle bg-success"></span>
