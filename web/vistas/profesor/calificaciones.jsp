...
<html>
    ...
    <body style="background: #343a40;">
            ...
            <div class="row mt-4">
                <div class="col-4 p-2">
                    <div class="card-body border border-light rounded p-4">
                        <h6 class="card-title text-light text-uppercase p-2 fs-6">registar calificacion</h6>
                        <div class="row">
                            <h6 class="text-uppercase text-light text-center fs-6">${profesor.nombreCompleto}</h6>
                        </div>
                        <div class="row p-2">
                            <div class="col">
                                <input type="text" class="form-control" id="floatingInput" placeholder="Calificación">
                            </div>
                            <div class="col">
                                <select class="form-select text-capitalize fs-6" aria-label="Default select example">
        ...
        <script>
                              ...
                              var a = '/vistas/profesor/calificaciones.jsp';
